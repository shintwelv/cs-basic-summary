...
- **해결 접근**: 
  ...
  2. 다음 방문할 '가장 가까운 거리의 노드'를 $O(\log E)$ 만에 찾을 수 있는 **[우선순위 큐(Min-Heap)](../data-structure/heap.md)** 를 도입한다. (**[스택 & 큐](../data-structure/stack-queue.md)** 원리 이해) (Swift는 내장 우선순위 큐가 없어 직접 배열과 완전이진트리 인덱스 조작을 통해 힙을 구현해야 한다.)
...
### 6. 연관 문제
- **[백준 1916 - 최소비용 구하기](./baekjoon-1916-최소비용구하기.md)**: 동일한 다익스트라 알고리즘을 사용하지만, 특정 목적지까지의 비용만 구하면 되는 변형 문제입니다.
</details>